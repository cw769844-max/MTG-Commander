...
import { SESSION_COOKIE, SESSION_COOKIE_OPTIONS, hashPassword, requireAuth, signSessionToken, verifyPassword } from "../auth";
...
authRouter.post("/register", async (req, res) => {
  ...
  res.cookie(SESSION_COOKIE, signSessionToken(user.id), SESSION_COOKIE_OPTIONS);
